...
const ClassDetail = () => {
  ...
  return (
    ...
    <div className="text=[10px] w-1/2 my-10 m-auto">
      ...
      <div>{courses1.CourseCode} - {courses1.Description}</div>
      ...
      <div className="border-[0.5px] border-[#e5e1e1] p-2">
        ...
        <div className="w-1/2 m-auto ">
          ...
          <div className="flex justify-between">
            {" "}
            <span className="font-bold">Units</span> <span>{courses1.Units}</span>
          </div>
          <div className="flex justify-between">
            {" "}
      ...
      <div>
        ...
        <div className="flex justify-between w-full">
          <div className="border-2 p-2 w-1/2">
            ...
            <div className="flex justify-between">
              {" "}
              <div className="">{courses1?.CourseCode}</div>{" "}
      ...
      <div>
        <div className="">{courses1.CourseCode} sections for OOD Semester 2023/2024</div>
        <div>View All</div>
