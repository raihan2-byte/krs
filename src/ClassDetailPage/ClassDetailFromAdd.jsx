  ...
  return (
    <>
      ...
      <div className="text=[10px] w-1/2 my-10 m-auto">
        ...
        <div>
          <div className="">
            {courses1.CourseCode} sections for OOD Semester 2023/2024
          </div>
          <div>View All</div>
