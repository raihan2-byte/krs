...
const MyCourse = () => {
    ...
    return (
      ...
      <div className="m-8 w-1/2">
          ...
          <div className="absolute w-full">
            <button
              className={`relative bottom-4 left-[35%] px-2 py-px border-black border-[3px] ${
                buttonStates.button1 ? 'bg-blue-500 text-white' : 'bg-white text-black'
              }`}
            ...
            <button
              className={`relative bottom-4 left-[37%] px-2 py-px border-black border-[3px] ${
                buttonStates.button2 ? 'bg-blue-500 text-white' : 'bg-white text-black'
              }`}
            ...
            <button
              className={`relative bottom-4 left-[39%] px-2 py-px border-black border-[3px] ${
                buttonStates.button3 ? 'bg-blue-500 text-white' : 'bg-white text-black'
              }`}
        ...
        <p>
          ODD/EVEN Semester 2024 | Undergraduate | Atma Jaya Catholic University
        </p>
        <a href="add-class">
            ...
            {courses?.map((item, index) => (
              ...
              <tr className="border-[2px] border-black">
                ...
                <td className="border-[2px] border-black">
                  <a href="class-detail" className="underline text-blue-500"
                  onClick={()=>(
        ...
        <button className="underline p-1 bg-orange-500 text-blue-500 font-bold border-2 border-black">Search</button>
        </div>
      </div>
    </div>
    </>
